...
import "./header.scss"; 
const Header = () => {
    // Mock user authentication state (replace this with real authentication logic)
    const [isLoggedIn, setIsLoggedIn] = useState(false);

    // Simulate checking for user login state (e.g., from a token or context)
    useEffect(() => {
        const token = localStorage.getItem("authToken"); // Example: Check localStorage for a token
